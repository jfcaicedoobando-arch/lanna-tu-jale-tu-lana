...
const clientTypes = {
  ...
  company: {
    ...
    note: 'El proceso para empresa toma un poco más — hay más documentos que validar. Valentina te guía paso a paso y te dice exactamente qué falta.',
  },
};
    ...
    <section id="requisitos" className="relative py-24 md:py-32 px-6 overflow-hidden">
      ...
      <div className="relative z-10 container max-w-4xl">
        ...
        >
          ...
          <div className="bg-surface/40 border border-border/20 rounded-2xl p-6 md:p-8">
            ...
            <div className="flex flex-wrap gap-2 mt-6 pt-4 border-t border-border/20">
              {['Todo por WhatsApp', 'Sin apps', 'Sin oficinas', 'Valentina te guía paso a paso'].map((tag, i) => (
        ...
        >
          ...
          <a
            href="https://wa.me/521234567890?text=Hola%20Valentina%2C%20quiero%20conocer%20LANNA"
            target="_blank"
