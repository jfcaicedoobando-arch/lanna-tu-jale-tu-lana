...
const faqs = [
  ...
  {
    q: '¿Qué pasa si la empresa no paga?',
    a: 'En Anticipo de Factura, la empresa es quien responde — tú ya tienes tu dinero. En Crédito Rotativo, tú respondes por el pago.',
  },
  {
  ...
  },
  {
    ...
    a: 'INE por los dos lados, título del troca o tarjeta de circulación, RFC y una factura de flete reciente. Todo lo mandas por WhatsApp — foto o PDF.',
  },
];
